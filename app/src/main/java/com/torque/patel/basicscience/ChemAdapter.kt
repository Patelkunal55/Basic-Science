...
import com.torque.patel.basicscience.PhyAdapter.Companion

class ChemAdapter(private val context:Context,
    ...
    inner class AdViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind() {
            ...
            // Initially set the adView to GONE
            adView.visibility = View.GONE
            val adLoader = AdLoader.Builder(context, context.getString(R.string.chem_admob_adunit_id))
