...
class QuizMenuAdapter(private val list:MutableList<QuizItem>,
                      private val itemClickListener: OnItemClickListner,
                      private val context: Context, val number:Int):
    ...
    ,View.OnClickListener{
        ...
        private val color_layout: LinearLayout = itemView.findViewById(R.id.color_linerlayout)
        ...
        fun bind(chapterNum: QuizItem.ListItem, chapterNam: QuizItem.ListItem){
            ...
            when(number) {
                0 -> {
                    color_layout.setBackgroundResource(R.drawable.circle_solid)

                }

                1 -> {
                    color_layout.setBackgroundResource(R.drawable.yellow_circle)
                    chapterNumber.setTextColor(R.color.black)
                }

                2 -> {
                    color_layout.setBackgroundResource(R.drawable.green_circle)
                }
    ...
    inner class AdViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind() {
            ...
            val adLoader = AdLoader.Builder(context, context.getString(R.string.quiz_menu_adunit_id))
